...
export function RecordingStopped({ onSubmit, onRecordAgain, play, pause, player }: RecordingStoppedProps) {
  return (
    <View className="gap-4 flex-1 justify-between pt-4">
      <View className="gap-2">
        ...
        <View className="flex-row gap-4 bg-bg-secondary rounded-full p-4">
          <TouchableOpacity onPress={player.paused ? play : pause}>
